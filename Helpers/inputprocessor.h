 ...
 * 'word' and an indicator whether a newline was processed. The string
 * argument will never be NULL and is always '\0' terminated. However it
 * may be a single zero byte (i.e. an empty string).
 *
